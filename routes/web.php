...
//Actualizar informaci�n referente a  la factura
Route::post('invoice/actualizarRegistroFactura', 'InvoiceController@actualizarRegistroFactura');

//Actualizar informaci�n referente a  la facturaci�n masiva
...
//Actualizar informaci�n de los recibos
