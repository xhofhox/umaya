            ...
            <div class="row">
             ...
             <div class="col-md-6">
               <div class="form-group">
                 ...
                 <input class="form-control" name="RFC" value="XAXX010101000"/>
               ...
               <div class="form-group">
                  <label for="Receptor">Razón Social</label>
                   <input class="form-control" name="razonsocial" value="Público en General"/>
               ...
               <div class="form-group">
                ...
                <select class="form-control col-md-8 selection-list" name="FormaPago">
                      ...
                      <option value="01"> 01 Efectivo </option>
                       ...
                       <option value="99" selected="true">99 Por definir</option> 
                </select>
              </div>
             </div>
            </div>              
