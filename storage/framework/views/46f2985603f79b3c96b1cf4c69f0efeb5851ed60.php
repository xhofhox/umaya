          ...
          <form method="POST" 
            ...
            <table class="bordered highlight table-responsive">
              ...
              <tbody>
                  ...
                  <tr>
                      <td><?php echo e($concept->ClaveProdServ); ?></td>
                      <td><?php echo e($concept->NoIdentificacion); ?></td>
                      <td><?php echo e($concept->Cantidad); ?></td>
                      <td><?php echo e($concept->ClaveUnidad); ?></td>
                      <td><?php echo e($concept->Descripcion); ?></td>
                      <td><?php echo e($concept->ValorUnitario); ?></td>
                      <td><?php echo e($concept->Importe); ?></td>
                      <!-- <td><?php echo e($concept->Descuento); ?></td> -->
                      <td>
                        <a href="#updateConcept<?php echo e($concept->Id); ?>" class="btn-floating btn-small waves-effect waves-light blue">
                          <i class="material-icons">mode_edit</i>
                        </a>
                      </td>
                  </tr>
                  <div id="#updateConcept<?php echo e($concept->Id); ?>" class="modal">
                      <div class="modal-content">
                          <div class="row">
                              <div class="input-field col s12 m6">
                                  <i class="material-icons prefix">account_circle</i>
                                  <input value="<?php echo e($concept->ClaveProductoServicio); ?>" title="Solo puede ingresar NÚMEROS en este campo." name="ClaveProductoServicio" type="text" class="validate" required>
