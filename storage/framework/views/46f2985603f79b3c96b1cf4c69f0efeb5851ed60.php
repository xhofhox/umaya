			...
			<div class="panel-heading"><h4>Nuevo CFDI Individual</h4></div>
				<div class="panel-body">
					<form method="POST" 
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control col-md-8 selection-list" name="UsoCFDI">
										<option value="selecciona">Selecciona</option>
										<option value="<?php echo e($invoice['data']['uso_cfdi']); ?>"><?php echo e($invoice['data']['val_uso_cfdi']); ?></option>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="form-control" name="RFC" value="<?php echo e($invoice['data']['rfc']); ?>"/>
									 <input class="form-control hide" name="Receptor" value="<?php echo e($invoice['data']['uid']); ?>"/>  
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="form-control" name="razonsocial" value="<?php echo e($invoice['data']['razonsocial']); ?>"/>
								</div>
							</div>
						</div> 
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control col-md-8 selection-list" name="FormaPago">
										<option value="selecciona">Selecciona</option>										
										<option value="<?php echo e($invoice['data']['forma_pago']); ?>" selected="true"><?php echo e($invoice['data']['val_forma_pago']); ?></option>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control col-md-8 selection-list" name="MetodoPago">
										<option value="selecciona">Selecciona</option>
										<!-- <option value="<?php echo e($invoice['data']['metodo_pago']); ?>"><?php echo e($invoice['data']['val_metodo_pago']); ?></option> -->
						...
						<div style="text-align: right; -webkit-text-stroke-width: medium;"> Total conceptos: $<?php echo e($totalConcepts); ?></div>
						<?php echo $__env->make('sweet::alert', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
						<?php echo $__env->make('previewInvoice', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
						<button id="btn-save-invoice" type="submit" class="btn btn-primary">Enviar</button>
						<a href="#" 
							class="btn btn-primary"
							data-target="#preview<?php echo e($invoice['data']['id']); ?>"
							data-toggle="modal">
							Previsualizar
						</a>
					</form>
